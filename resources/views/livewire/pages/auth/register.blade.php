<x-guest-layout title="Register - FinTrack">
    ...
    {{-- <div class="min-h-screen flex items-center justify-center py-10 px-4 sm:px-6 lg:px-8 relative overflow-hidden"> --}}
        ...
        <div
            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-indigo-100 text-sm md:text-base leading-relaxed font-medium opacity-90">
                        Bergabunglah dengan ribuan pengusaha yang telah merapikan keuangan bisnis mereka dalam satu
                        platform terintegrasi.
                    </p>
                </div>

                <!-- Bagian Bawah (UPDATED: ditambah mb-20 biar naik sedikit) -->
            ...
            <!-- KOLOM KANAN: FORM -->
            <div
                class="w-full md:w-7/12 bg-white dark:bg-slate-900 p-8 md:p-12 flex flex-col justify-center relative overflow-y-auto">
                ...
                @if ($errors->any())
                    <div
                        class="mb-6 p-4 bg-red-50/80 dark:bg-red-900/20 backdrop-blur-sm border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 rounded-2xl text-sm">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div class="space-y-2">
                        <label
                            class="text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider ml-1">Full
                            Name</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <i
                                    class="ph ph-user text-lg text-slate-400 group-focus-within:text-indigo-600 transition-colors duration-300"></i>
                            </div>
                    ...
                    <div class="space-y-2">
                        <label
                            class="text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider ml-1">Confirm
                            Password</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <i
                                    class="ph ph-shield-check text-lg text-slate-400 group-focus-within:text-indigo-600 transition-colors duration-300"></i>
                            </div>
                ...
                <div class="mt-8 text-center text-sm text-slate-500 dark:text-slate-400 font-medium">
                    Sudah punya akun?
                    <a href="{{ route('login') }}"
                        class="text-indigo-600 dark:text-indigo-400 font-bold hover:text-indigo-500 hover:underline ml-1">Login
                        disini</a>
                </div>
