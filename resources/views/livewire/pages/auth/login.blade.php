    ...
    <div class="min-h-screen flex items-center justify-center py-10 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div
            ...
            <div
                ...
                <!-- Bagian Bawah: Statistik (UPDATED: ditambah mb-20 biar naik sedikit) -->
                <div class="relative z-10 mt-8 mb-20">
                    <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-5">
                        ...
                        <p class="text-xs text-indigo-100 leading-relaxed">
                            Bisnis yang menggunakan FinTrack melihat peningkatan efisiensi hingga 40% dalam 3 bulan
                            pertama.
                        </p>
                    </div>
                </div>
            ...
            <div class="w-full md:w-7/12 bg-white dark:bg-slate-900 p-8 md:p-12 flex flex-col justify-center relative">
                ...
                <div class="mb-10 max-w-md">
                    ...
                    <p class="text-slate-500 dark:text-slate-400 text-sm">Silakan masukkan kredensial akun Anda untuk
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        <label
                            class="text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider ml-1">Password</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <i
                                    class="ph ph-lock-key text-lg text-slate-400 group-focus-within:text-indigo-600 transition-colors duration-300"></i>
                            </div>
                    ...
                    <div class="flex items-center justify-between text-sm font-medium">
                        <label
                            class="flex items-center gap-3 cursor-pointer text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors select-none">
                            <input type="checkbox" name="remember"
                                class="w-4 h-4 rounded text-indigo-600 focus:ring-indigo-500 border-slate-300 dark:border-slate-600 bg-transparent">
                            <span class="text-xs font-bold">Ingat Saya</span>
                        </label>
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}"
                                class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 font-semibold hover:underline">Lupa
                                Password?</a>
                        @endif
                    </div>

                    <!-- Button Submit (UPDATED COLORS) -->
                    <button type="submit"
                        ...
                        <!-- Overlay putih transparan pas hover biar efek kilapnya bagus -->
                        <div
                ...
                <div class="mt-8 text-center text-sm text-slate-500 dark:text-slate-400 font-medium">
                    ...
                    <a href="{{ route('register') }}"
                        class="text-indigo-600 dark:text-indigo-400 font-bold hover:text-indigo-500 hover:underline ml-1">Buat
                        Akun Baru</a>
                </div>
